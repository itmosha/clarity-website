            ...
            <Flex justify={'space-between'} w={'100vw'} p={'14px 3vw'}>
                ...
                <Flex>
                    <ButtonGroup gap={'10px'}>
                        <Button variant={'ghost'} _hover={{ bgColor: 'rgba(78, 71, 89, .5)' }} rounded={'full'}>
                            <Link href={'/'} style={{ textDecoration: 'none' }}>
                                <Text fontSize={'0.9rem'} textColor={'#C2C6CA'} textTransform={'uppercase'}>About</Text>
                            </Link>
                        </Button>
                        <Button variant={'ghost'} _hover={{ bgColor: 'rgba(78, 71, 89, .5)' }} rounded={'full'}>
                            <Link href={'/'} style={{ textDecoration: 'none' }}>
                                <Text fontSize={'0.9rem'} textColor={'#C2C6CA'} textTransform={'uppercase'}>Log out</Text>
                            </Link>
                        </Button>
                        <Button variant={'ghost'} _hover={{ bgColor: 'rgba(78, 71, 89, .5)' }} rounded={'full'}>
                            <Link href={'/'} style={{ textDecoration: 'none' }}>
                                <Text fontSize={'0.9rem'} textColor={'#C2C6CA'} textTransform={'uppercase'}>My account</Text>
                            </Link>
                        </Button>
                    </ButtonGroup>
                </Flex>
